...
""",
    ...
    try:
        ...
        async def scenario():
            ...
            snapshot = structured(await mcp.call_tool(
                "ingest_coverage",
                {
            ...
            file_payload = structured(await mcp.call_tool(
                "coverage_file",
...
""",
    ...
    try:
        ...
        async def scenario():
            command = structured(await mcp.call_tool(
                "register_test_command",
                {
                    "name": "failing-suite",
            ...
            run = structured(await mcp.call_tool(
                "run_command_profiled",
            ...
            topology = structured(await mcp.call_tool(
                "object_topology",
                {"object_kind": "run", "object_ref": run["id"]},
            ))
            artifact = structured(await mcp.call_tool(
                "latest_artifact",
...
def test_mcp_coverage_query_surface_and_resources(tmp_path):
    ...
    try:
        ...
        async def scenario():
            base_snapshot = structured(await mcp.call_tool(
                "ingest_coverage",
                {
            ...
            current_snapshot = structured(await mcp.call_tool(
                "ingest_coverage",
                {
